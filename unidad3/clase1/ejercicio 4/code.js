...
console.log("------Prompt y Alert------")

let nombre2 = prompt("¿Cuál es tu nombre?");
alert("Hola, " + nombre2);//muestra un mensaje de alerta saludando al usuario por su nombre

let ciudad = prompt("¿En qué ciudad vives?");
console.log("Ciudad ingresada:", ciudad); //Muestra en la consola la ciudad ingresada por el usuario

let edad2 = prompt("¿Cuantos años tienes?");//devuelve "25" (string)
console.log(edad2 + 1);//imprime "251" (concatena, no suma) 

let edad3 = Number(prompt("¿Cuantos años tienes?"));//convierte a Number
console.log(edad3 + 1);//imprime 26 (suma correctamente)

console.log("------ejercicio------")
let nombre3 = prompt("¿Cuál es tu nombre?");
let edad4 = Number(prompt("¿Cuantos años tienes?"));
console.log(edad4 + 5 )
alert("Hola, " + nombre3 + ". En 5 años tendrás " + (edad4 + 5) + " años.");